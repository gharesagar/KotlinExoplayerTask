...
class VideoPlayerRecyclerView : RecyclerView {
    ...
    // vars
    private var movieObjects = ArrayList<Movie>()
    private var videoSurfaceDefaultHeight = 0
    private var screenDefaultHeight = 0
    private lateinit var contextn: Context
    ...
    private fun init(context: Context) {
        contextn = context.applicationContext
    ...
    fun playVideo(isEndOfList: Boolean) {
        ...
        if (!isEndOfList) {
            ...
            targetPosition = movieObjects.size - 1
        }
        ...
        val mediaUrl = movieObjects[targetPosition].mediaUrl
        if (mediaUrl != null) {
    ...
    fun setMovieObjects(movieObjects: ArrayList<Movie>) {
